...
package object response {
  ...
  final case class CheckoutValidateResponse(status: String, description: String, checkoutToken: String)

  final case class WalletTransferResponse(status: String, description: String, transactionId: String)

  final case class TopUpStashResponse(status: String, description: String, transactionId: String)

  final case class BankTransferResponse(bankEntries: List[BankEntry], errorMessage: Option[String] = None)
